...
export declare const Title: import("create-emotion-styled/types/react").StyledOtherComponent<WithHasRightButton, import("../FlexBox").FlexBoxProperties, import("../theme").Theme>;
