 ...
 * @property {MessageInput.InputAreaStyle} areaStyle - Styles of the message input's input element.
 */
 ...
 * @property {Theme.ButtonThemeProps} Button Styles for the message input's button
 */
 ...
 * @property {Theme.MessageInputThemeProps} [theme.MessageInput] - theme
