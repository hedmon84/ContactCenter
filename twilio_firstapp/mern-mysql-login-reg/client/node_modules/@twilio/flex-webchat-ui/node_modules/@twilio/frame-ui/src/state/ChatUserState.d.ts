 ...
 * @property {UserDescriptor} sid User descriptor of the user by sid. See structure here: {@link  https://media.twiliocdn.com/sdk/js/chat/releases/3.2.4/docs/UserDescriptor.html}
 * @category State
 */
